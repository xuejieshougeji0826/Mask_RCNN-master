...
class DrugDataset(utils.Dataset):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, dataset_root_path):
        ...
        """
        # Add classes
        self.add_class("shapes", 1, "Eraser")
        self.add_class("shapes", 2, "Pen")
        self.add_class("shapes", 3, "Toy")
        self.add_class("shapes", 4, "Glue")
        self.add_class("shapes", 5, "Clip")
        self.add_class("shapes", 6, "Bottle")
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("Eraser") != -1:
                # print "car"
                labels_form.append("Eraser")
            elif labels[i].find("Pen") != -1:
                # print "leg"
                labels_form.append("Pen")
            elif labels[i].find("Toy") != -1:
                # print "well"
                labels_form.append("Toy")
            elif labels[i].find("Glue") != -1:
                # print "leg"
                labels_form.append("Glue")
            elif labels[i].find("Clip") != -1:
                # print "leg"
                labels_form.append("Clip")
            elif labels[i].find("Bottle") != -1:
                # print "leg"
