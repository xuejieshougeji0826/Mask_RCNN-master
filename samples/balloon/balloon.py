...
class BalloonDataset(utils.Dataset):
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("balloon", 1, "Eraser")
        self.add_class("balloon", 2, "Pen")
        self.add_class("balloon", 3, "Toy")
        self.add_class("balloon", 4, "Glue")
        self.add_class("balloon", 5, "Clip")
        self.add_class("balloon", 6, "Bottle")
